...
.sidebar-wrapper {
    ...
    background: linear-gradient(to bottom, #4a90e2 0%, #2e6bb8 100%); /* Latar belakang gelap */
    color: #ffff; /* Warna teks default sidebar */
...
.sidebar-nav .nav-link.active {
    background-color: #84b1e3; /* Warna latar belakang item aktif (biru Bootstrap primary) */
...
.sidebar-nav i {
    ...
    width: 25px;
    text-align: center;
    color: #fff; /* Warna ikon default untuk item non-aktif. Ubah ke #fff jika ingin putih. */
}
...
<div class="card shadow-sm sidebar-wrapper">
    <div class="card-body p-0 d-flex flex-column"> {{-- d-flex flex-column untuk flexbox vertikal --}}
        ...
        <ul class="nav flex-column sidebar-nav"> {{-- Hapus flex-grow-1 dari sini --}}
            ...
            {{-- Perbaiki Link untuk Laporan Bezetting --}}
            <li class="nav-item">
                <a href="{{ route('settings.bezetting.index') }}" class="nav-link d-flex align-items-center {{ request()->routeIs('settings.bezetting.*') ? 'active' : '' }}">
                    <i class="fas fa-chart-bar me-3"></i> {{-- Menggunakan Font Awesome icon --}}
                    Laporan Bezetting
                </a>
            </li>
            {{-- Perbaiki Link untuk Manajemen Data Bezetting Kontrak --}}
            <li class="nav-item">
                <a href="{{ route('settings.bezetting_kontrak.index') }}" class="nav-link d-flex align-items-center {{ request()->routeIs('settings.bezetting_kontrak.*') ? 'active' : '' }}">
                    <i class="fas fa-user-tie me-3"></i> {{-- Menggunakan Font Awesome icon --}}
                    Data Kontrak (Bezetting)
                </a>
            </li>
