...
<div class="form-container">
    ...
    <form method="POST" action="{{ route('pegawai.update', $pegawai->id) }}" enctype="multipart/form-data">
        ...
        {{-- Ini penting agar nilai _redirect_to ikut terkirim saat form disubmit --}}
        ...
        <div class="form-actions">
            ...
            {{-- PERUBAHAN DI SINI: Tombol Batal akan kembali ke URL yang ada di _redirect_to --}}
            @if(request()->has('_redirect_to'))
                <a href="{{ request('_redirect_to') }}" class="btn-batal">Batal</a>
            @else
                {{-- Fallback jika _redirect_to tidak ada, kembali ke halaman index --}}
                <a href="{{ route('pegawai.index') }}" class="btn-batal">Batal</a>
            @endif
        </div>
    </form>
</div>
