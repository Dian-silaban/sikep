    ...
    <div class="col-md-12">
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="mb-0">Daftar Jaga Usulan Kenaikan Pangkat</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('reports.usulan-kenaikan-pangkat.index') }}" method="GET" class="mb-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6>DAFTAR JAGA USULAN KENAIKAN PANGKAT</h6>
                    ...
                    <form action="{{ route('reports.usulan-kenaikan-pangkat.export-excel') }}" method="GET" class="d-inline">
                    ...
                    <table class="table table-bordered table-sm text-center align-middle" style="font-size: 0.85em;">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2">TMT</th>
                                <th colspan="{{ count(range($selectedYear - 4, $selectedYear + 8)) }}">TAHUN</th>
                                <th rowspan="2">KET</th>
                            </tr>
                            <tr>
