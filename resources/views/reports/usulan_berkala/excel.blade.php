...
<html>
<head>
    <title>Buku Jaga Usulan Berkala</title>
    <style>
        table {
            width: 100%;
...
<body>
    <div class="header-title">DAFTAR JAGA USULAN BERKALA</div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="{{ 4 + count($proyeksiYears) + 1 }}">Tidak ada data usulan berkala untuk filter ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
